...
folder = r"Z:/personal_data/Filip_Liebsch/SP8_Biocenter_small/2025-04-23_floxed/G134R_project/data/"
...
def execute(root, tbl):
    ...
    df['ClusterSize'] = df['Gphn_area'] * 0.003300776071
    df['Cluster'] = df['ClusterSize'].between(0.1, 1)
    # synaptic clusters inside cell
    cell_syn_cluster_cols = ['vGAT', 'gamma2', 'Neuron', 'Cluster']
    ...
    soma_syn_cluster_cols = ['vGAT','gamma2', 'Soma', 'Cluster']
    ...
    # intensity
    mean_intensity = df.loc[cell_syn_mask, 'Gphn_mean'].mean()
