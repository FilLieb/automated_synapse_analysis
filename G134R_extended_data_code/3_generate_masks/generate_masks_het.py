...
def execute(root):
    ...
    make_masks("mEGFP-Gphn", 2, out_path, image)
    make_masks("vGAT", 1, out_path, image)
    make_masks("mScarlet-Gphn", 3, out_path, image)
    make_soma_neuron_masks(out_path, image)

    make_intensity_images("mEGFP-Gphn", 2, out_path, confocal)
    make_intensity_images("vGAT", 1, out_path, confocal)
    make_intensity_images("mScarlet-Gphn", 3, out_path, confocal)
